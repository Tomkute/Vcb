...
@section('contents')
    ...
    <header>
        <div class="container pt-3" >
            <div class="row">
                <h1 class="text-center w-100 text-danger alert alert-primary m-0" > Closed - Opened System </h1>
        ...
        <div class="row">
            <table class="table table-bordered text-center table-hover table-striped">
                ...
                <tr>
                    ...
                    <td><span class="badge badge-secondary mr-2 font-weight-bolder"> CLOSE </span> Batch Trarde Finace (TF) </td>
                ...
                <tr>
                    ...
                    <td><p class="name w-100"></p></td>
                    <td>RUN</td>
                    <td>  <span class="badge badge-secondary mr-2 font-weight-bolder"> CLOSE </span> Banch  (Mosaic) </td>
                    <td colspan="2"><input type="checkbox"></td>
                    <td><input type="text" class="border-0 text-danger" style="background-color: inherit"></td>
                </tr>
                <tr>
                    ...
                    <td><p class="name w-100"></p></td>
                    <td>RUN</td>
                    <td> <span class="badge badge-secondary mr-2 font-weight-bolder"> OPEN </span> Batch Trarde Finace (TF) </td>
                    <td colspan="2"><input type="checkbox"></td>
                    <td><input type="text" class="border-0 text-danger" style="background-color: inherit"></td>
                </tr>
                <tr>
                    ...
                    <td><p class="name w-100"></p></td>
                    <td>RUN</td>
                    <td> <span class="badge badge-secondary mr-2 font-weight-bolder"> OPEN </span>Banch  (Mosaic) </td>
                    <td colspan="2"><input type="checkbox"></td>
                    <td><input type="text" class="border-0 text-danger" style="background-color: inherit"></td>
                </tr>
                </tbody>
